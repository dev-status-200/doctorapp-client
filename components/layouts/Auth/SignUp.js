...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password != confirmPass) {
      ...
      await delay(3000);
      await axios
        .post(process.env.NEXT_PUBLIC_DOCTOR_SIGN_UP, {
          firstName,
          lastName,
          email,
          phone,
    ...
    <div className="login-styles">
        ...
        <Col md={5}>
          <Container className="px-2 pt-5 top-container">
            <div className="px-5 pt-1">
              ...
              <p className="grey2-txt mt-3">
                Enter following fields for signup
              </p>
          ...
          <Container className="bottom-container px-5">
            <div>
              <p className="grey2-txt" style={{ fontSize: 13 }}>
                Enter your details to continue
              </p>
            </div>
            <Link href={"/login"} className="no-link orange-txt pb-3">
              Login Instead
            </Link>
          </Container>
        </Col>
      ...
      >
        <div className="fade-in-styles ">
          <div className="fade-in-image text-center pt-4 my-3">
            <AiFillCheckCircle size={100} color="#437c2d" />
            <h4 className="mt-4">Congratulation</h4>
            <h6 className="mb-3">your account has been created!</h6>
            <div>Please Wait...</div>
          </div>
        </div>
      </Modal>
